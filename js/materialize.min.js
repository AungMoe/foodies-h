            ...
            if ("scroll" === C) {
              ...
              h.container
                ? p.isWrapped(h.container) || p.isNode(h.container)
                  ...
                  : (h.container = null)
                : ((w = t.State.scrollAnchor[t.State["scrollProperty" + D]]),
                  (z =
                    t.State.scrollAnchor[
                      t.State[
          ...
          function e() {
            ...
            if (
              (e + i.innerWidth() > a(window).width()
                ? (f = "right")
                : e - i.innerWidth() + g.innerWidth() < 0 && (f = "left"),
              "left" === f)
            )
        ...
        a(this).each(function () {
          ...
          if (!d.hasClass("browser-default")) {
            ...
            d.before(p),
              p.before(n),
              a("body").append(j),
              d.is(":disabled") || p.dropdown({ hover: !1, closeOnClick: !1 }),
              d.attr("tabindex") &&
                a(p[0]).attr("tabindex", d.attr("tabindex")),
              d.addClass("initialized"),
              p.on({
                focus: function () {
                  j.is(":visible") || a(this).trigger("open"),
                    a("ul.select-dropdown").not(j[0]).is(":visible") &&
              ...
              r = function (b) {
                ...
                if (13 != b.which || j.is(":visible")) {
                  ...
                  40 == b.which &&
                    ...
                    38 == b.which &&
                      ((g = j.find("li.selected").prev("li:not(.disabled)")[0]),
                      g && activateOption(j, g)),
                    setTimeout(function () {
                      q = [];
                    }, 1e3);
          ...
          this.each(function () {
            ...
            if (
              ...
              f.hasClass("fullscreen") ||
                (b.indicators ? f.height(b.height + 40) : f.height(b.height),
                g.height(b.height)),
