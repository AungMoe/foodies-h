        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/tryit.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
...
<div id="work-collections" class="seaction">
                            ...
                            <span>Bath '.$row1['price'].'</span>
								...
								echo'<li class="collection-item">
                                        <div class="row">
                                            ...
                                            <div class="col s3">
                                                <span><strong>Bath '.$row['total'].'</strong></span>
                                            </div>';										
								if(!$deleted){
  ...
  <footer class="page-footer">
    <div class="footer">
      <div class="container">
        <span>AungHlaingMoe(5745402)</span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
